...
public class Map 
{
	...
	final byte  DEEP = 1;
	final byte  BEACH = 2;
	final byte  SHALLOW = 3;
	final byte  GRASS_BEACH_IN_1 = 4;
	final byte  GRASS_BEACH_IN_2 = 5;
	final byte  GRASS_BEACH_IN_3 = 6;
	final byte  GRASS_BEACH_IN_4 = 7;
	final byte  GRASS_BEACH_OUT_1 = 8; 
	final byte  GRASS_BEACH_OUT_2 = 9;
	final byte  GRASS_BEACH_OUT_3 = 10;
	final byte  GRASS_BEACH_OUT_4 = 11;
	final byte  GRASS_BEACH_1 = 12;
	final byte  GRASS_BEACH_2 = 13;
	final byte  GRASS_BEACH_3 = 14;
	final byte  GRASS_BEACH_4 = 15;
	final byte  BEACH_SHALLOW_IN_1 = 16;
	final byte  BEACH_SHALLOW_IN_2 = 17;
	final byte  BEACH_SHALLOW_IN_3 = 18;
	final byte  BEACH_SHALLOW_IN_4 = 19;
	final byte  BEACH_SHALLOW_OUT_1 = 20;
	final byte  BEACH_SHALLOW_OUT_2 = 21;
	final byte  BEACH_SHALLOW_OUT_3 = 22;
	final byte  BEACH_SHALLOW_OUT_4 = 23;
	final byte  SHALLOW_DEEP_IN_1 = 24;
	final byte  SHALLOW_DEEP_IN_2 = 25;
	final byte  SHALLOW_DEEP_IN_3 = 26;
	final byte  SHALLOW_DEEP_IN_4 = 27;
	final byte  SHALLOW_DEEP_OUT_1 = 28;
	final byte  SHALLOW_DEEP_OUT_2 = 29;
	final byte  SHALLOW_DEEP_OUT_3 = 30;
	final byte  SHALLOW_DEEP_OUT_4 = 31;
	final byte  SHALLOW_DEEP_1 = 32;
	final byte  SHALLOW_DEEP_2 = 33;
	final byte  SHALLOW_DEEP_3 = 34;
	final byte  SHALLOW_DEEP_4 = 35;
	final byte  BEACH_SHALLOW_1 = 36;
	final byte  BEACH_SHALLOW_2 = 37;
	final byte  BEACH_SHALLOW_3 = 38;
	final byte  BEACH_SHALLOW_4 = 39;
