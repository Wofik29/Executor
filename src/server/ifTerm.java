		...
		if (current_command != null) {
			...
			if (current_number == 0) {
				...
				case 0:	// Если условие совпадает, то проверяем, есть ли else.
					...
					else //Если условие выполняется и есть else, то он будет и концом if'a
				...
				case 1:	// Если не совпадает, то переходим к else, или вообще выходим.
					...
					break;
				case -1:
					if (Game.isError) System.out.println("ControlLoop вернул -1: term1 - "+term1+", term2 - "+term2+", condition - "+condition);
